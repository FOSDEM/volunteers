...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'volunteers_language', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('iso_code', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal(u'volunteers', ['Language'])

        # Adding model 'VolunteerLanguage'
        db.create_table(u'volunteers_volunteerlanguage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volunteer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Volunteer'])),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Language'])),
        ))
        db.send_create_signal(u'volunteers', ['VolunteerLanguage'])


    def backwards(self, orm):
        # Deleting model 'Language'
        db.delete_table(u'volunteers_language')

        # Deleting model 'VolunteerLanguage'
        db.delete_table(u'volunteers_volunteerlanguage')

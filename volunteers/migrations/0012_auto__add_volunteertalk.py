...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolunteerTalk'
        db.create_table(u'volunteers_volunteertalk', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volunteer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Volunteer'])),
            ('talk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Talk'])),
        ))
        db.send_create_signal(u'volunteers', ['VolunteerTalk'])


    def backwards(self, orm):
        # Deleting model 'VolunteerTalk'
        db.delete_table(u'volunteers_volunteertalk')

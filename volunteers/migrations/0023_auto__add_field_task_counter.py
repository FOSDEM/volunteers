...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.counter'
        db.add_column(u'volunteers_task', 'counter',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.counter'
        db.delete_column(u'volunteers_task', 'counter')
    ...
    models = {
        ...
        u'volunteers.task': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'edition': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': u"orm['volunteers.Edition']"}),
            'end_time': ('django.db.models.fields.TimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

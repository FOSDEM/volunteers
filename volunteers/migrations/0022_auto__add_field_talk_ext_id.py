...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Talk.ext_id'
        db.add_column(u'volunteers_talk', 'ext_id',
                      self.gf('django.db.models.fields.CharField')(default='xxx', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Talk.ext_id'
        db.delete_column(u'volunteers_talk', 'ext_id')
    ...
    models = {
        ...
        u'volunteers.task': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'edition': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'to': u"orm['volunteers.Edition']"}),
            'end_time': ('django.db.models.fields.TimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskCategory.active'
        db.add_column(u'volunteers_taskcategory', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskCategory.active'
        db.delete_column(u'volunteers_taskcategory', 'active')
    ...
    models = {
        ...
        u'volunteers.track': {
            ...
            'edition': ('django.db.models.fields.related.ForeignKey', [], {'default': 'False', 'to': u"orm['volunteers.Edition']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_time': ('django.db.models.fields.TimeField', [], {}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.private_staff_rating'
        db.add_column(u'volunteers_volunteer', 'private_staff_rating',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Volunteer.private_staff_notes'
        db.add_column(u'volunteers_volunteer', 'private_staff_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.private_staff_rating'
        db.delete_column(u'volunteers_volunteer', 'private_staff_rating')

        # Deleting field 'Volunteer.private_staff_notes'
        db.delete_column(u'volunteers_volunteer', 'private_staff_notes')

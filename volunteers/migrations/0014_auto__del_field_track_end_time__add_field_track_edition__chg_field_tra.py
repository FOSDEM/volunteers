...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Track.end_time'
        db.delete_column(u'volunteers_track', 'end_time')
        ...
        # Changing field 'Track.description'
        db.alter_column(u'volunteers_track', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Adding field 'Track.end_time'
        db.add_column(u'volunteers_track', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(default=''),
                      keep_default=False)

        # Deleting field 'Track.edition'
        db.delete_column(u'volunteers_track', 'edition_id')


        # Changing field 'Track.description'
        db.alter_column(u'volunteers_track', 'description', self.gf('django.db.models.fields.TextField')(default=''))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Edition.visible_from'
        db.add_column(u'volunteers_edition', 'visible_from',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Edition.visible_until'
        db.add_column(u'volunteers_edition', 'visible_until',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Edition.visible_from'
        db.delete_column(u'volunteers_edition', 'visible_from')

        # Deleting field 'Edition.visible_until'
        db.delete_column(u'volunteers_edition', 'visible_until')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'volunteers_edition', 'year')

        # Adding field 'Edition.name'
        db.add_column(u'volunteers_edition', 'name',
                      self.gf('django.db.models.fields.CharField')(default='2014', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Edition.year'
        db.add_column(u'volunteers_edition', 'year',
                      self.gf('django.db.models.fields.IntegerField')(default=2014),
                      keep_default=False)

        # Deleting field 'Edition.name'
        db.delete_column(u'volunteers_edition', 'name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.nbr_volunteers_min'
        db.add_column(u'volunteers_task', 'nbr_volunteers_min',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Task.nbr_volunteers_max'
        db.add_column(u'volunteers_task', 'nbr_volunteers_max',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.nbr_volunteers_min'
        db.delete_column(u'volunteers_task', 'nbr_volunteers_min')

        # Deleting field 'Task.nbr_volunteers_max'
        db.delete_column(u'volunteers_task', 'nbr_volunteers_max')

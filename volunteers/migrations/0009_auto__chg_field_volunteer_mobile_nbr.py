...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volunteer.mobile_nbr'
        db.alter_column(u'volunteers_volunteer', 'mobile_nbr', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Volunteer.mobile_nbr'
        db.alter_column(u'volunteers_volunteer', 'mobile_nbr', self.gf('django.db.models.fields.TextField')(null=True))

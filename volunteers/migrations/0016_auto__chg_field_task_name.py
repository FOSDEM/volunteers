...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.name'
        db.alter_column(u'volunteers_task', 'name', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Task.name'
        db.alter_column(u'volunteers_task', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

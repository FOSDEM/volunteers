...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'volunteers_talk', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Talk.speaker'
        db.alter_column(u'volunteers_talk', 'speaker', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Talk.title'
        db.alter_column(u'volunteers_talk', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Talk.speaker'
        db.alter_column(u'volunteers_talk', 'speaker', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'volunteers.talk': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 1, 0, 0)'}),
            ...
            'volunteers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['volunteers.Volunteer']", 'null': 'True', 'through': u"orm['volunteers.VolunteerTalk']", 'blank': 'True'})
        },
        u'volunteers.task': {
        ...
        u'volunteers.volunteerlanguage': {
            'Meta': {'object_name': 'VolunteerLanguage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['volunteers.Language']"}),
            'volunteer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['volunteers.Volunteer']"})
        },
        ...
        u'volunteers.volunteertalk': {
            'Meta': {'object_name': 'VolunteerTalk'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'talk': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['volunteers.Talk']"}),
            'volunteer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['volunteers.Volunteer']"})
        },
